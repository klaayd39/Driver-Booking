      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: 28 }}>
            ...
            <h2 style={{ fontSize: 22, color: '#1c1a17', marginBottom: 8 }}>Forgot password?</h2>
            <p style={{ fontSize: 13, color: '#9c9890', lineHeight: 1.6 }}>
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input
                ...
                style={{ width: '100%', padding: '10px 12px 10px 36px', border: '1px solid #e4e1d8', borderRadius: 10, fontSize: 14, background: '#faf9f7', outline: 'none' }}
          ...
          <button
            ...
            style={{
              ...
              background: 'transparent', color: '#1a5c9a', cursor: loading ? 'not-allowed' : 'pointer',
        ...
        {isLogin && (
          <div style={{ textAlign: 'right', marginBottom: 24 }}>
            <button
              ...
              style={{ border: 'none', background: 'transparent', color: '#1a5c9a', cursor: 'pointer', fontSize: 12, fontWeight: 500, padding: 0 }}
            >
              Forgot password?
            </button>
          </div>
